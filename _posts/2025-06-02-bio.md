...
My research focuses on advancing **artificial intelligence and natural language processing** with particular emphasis on:

- **Low-resource language processing**: Pioneering work in Maithili language NLP, creating first-of-its-kind corpora and benchmark models for underrepresented languages
- **AI Safety and Optimization**: Developing robust methodologies for secure and efficient AI systems, including advanced evaluation frameworks for large language models
- **Computer Vision Applications**: Implementing state-of-the-art deep learning models for real-world applications including counterfeit detection and character recognition
- **Multi-agent Systems**: Designing and implementing retrieval-augmented generation (RAG) systems with intelligent guardrails and security mechanisms

Recent research contributions include breakthrough work in **AI optimization techniques** and **advanced neural architectures** for enhanced performance in specialized domains. My latest publication explores cutting-edge methodologies in machine learning optimization and security frameworks for production AI systems.
