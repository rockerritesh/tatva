---
title: The Lunar Wheel of Devotion
date: 2026-04-25
---
<img src="/posts/2026/04/25/lunar-wheel-of-devotion/lunar-wheel-hero.png" alt="Krishna playing flute, in Shiva-blue with skull mala and crescent moon, surrounded by Shakti devotees and Kamadhenu cows" width="100%">
...
The full input data — every tithi, every Jayanti counted, every weight — is published alongside this post as [`tithi-data.csv`](/posts/2026/04/25/lunar-wheel-of-devotion/tithi-data.csv) and the script that produces the wheel as [`make_tithi_wheel.py`](/posts/2026/04/25/lunar-wheel-of-devotion/make_tithi_wheel.py). Disagree with the folding or the weights? Edit them and re-run.

## The plot

![Lunar Wheel of Devotion: 15 tithis colored by dominant stream, with a stacked bar showing exact Shiva/Shakti/Vishnu split](/posts/2026/04/25/lunar-wheel-of-devotion/tithi-wheel.png)
